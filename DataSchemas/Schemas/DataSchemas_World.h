...
SchemaBegin(Box)
	...
	Field_Schema(Vec2, TextureOffset, "0,0")
...
SchemaBegin(Triangle)
	Field_Schema(Vec3, A, "0,0,0")
	Field_Schema(Vec3, B, "0,0,0")
	Field_Schema(Vec3, C, "0,0,0")
	Field_Schema(Vec2, TextureA, "0,0")
	Field_Schema(Vec2, TextureB, "0,0")
	Field_Schema(Vec2, TextureC, "0,0")
	Field(std::string, Material, "")
	Field(bool, CastShadows, true)
	Field(std::string, Portal, "")
SchemaEnd
...
SchemaBegin(SectorPlane)
	...
	Field(bool, ConnectToSetPosition, false)
	Field_Schema(Vec3, ConnectToPosition, "0,0,0")
SchemaEnd
...
SchemaBegin(Sector)
	...
	Field_Schema_Array(Triangle, Triangle)
